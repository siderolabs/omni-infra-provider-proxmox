...
func (m *MachineSpec) CloneVT() *MachineSpec {
	...
	r.StartAttempts = m.StartAttempts
...
func (this *MachineSpec) EqualVT(that *MachineSpec) bool {
	...
	if this.StartAttempts != that.StartAttempts {
		return false
	}
...
func (m *MachineSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.StartAttempts != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.StartAttempts))
		i--
		dAtA[i] = 0x70
	}
	if m.HaRegistered {
...
func (m *MachineSpec) SizeVT() (n int) {
	...
	if m.StartAttempts != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.StartAttempts))
	}
